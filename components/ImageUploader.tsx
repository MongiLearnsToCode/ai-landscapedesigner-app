          ...
          <div className="text-slate-500">
           ...
           <>
             <div className="relative w-full rounded-xl overflow-hidden">
               ...
               <div className="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity rounded-xl gap-2 hidden lg:block">
