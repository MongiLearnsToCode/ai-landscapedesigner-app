      ...
      >
        <div className="relative w-full aspect-video bg-slate-100">
          ...
          {item.isPinned && !isSelectionMode && (
           ...
           {!isSelectionMode && (
             <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center gap-2 transition-opacity p-2 pointer-events-none group-hover:pointer-events-auto hidden lg:flex">
